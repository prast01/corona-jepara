...
<body class="gradient-banner">
    ...
    <div class="site-wrap" style="background-image: linear-gradient(344.09deg, #D62255 0%, #FF4D4A 100%);">
        ...
        <!-- <div class="slant-1" style="background-image: linear-gradient(344.09deg, #D62255 0%, #FF4D4A 100%);"></div> -->

        <div class="site-section first-section py-5 my-2">
            <div class="container">
                <div class="row mb-2">
                ...
                <div class="row mb-5">
                    <div class="col-md-12 text-center text-white" data-aos="fade">
        ...
        <footer class="site-footer bg-dark py-4">
            <div class="container">
                <div class="row">
